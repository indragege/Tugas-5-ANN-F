...
# Visualisasi tren kasus pneumonia untuk semua kabupaten/kota
plt.figure(figsize=(12, 6))
for kota in df['nama_kabupaten_kota'].unique():
    data_kota = df[df['nama_kabupaten_kota'] == kota]
    plt.plot(data_kota['tahun'], data_kota['jumlah_kasus'], label=kota, marker='o')

plt.xlabel("Tahun")
plt.ylabel("Jumlah Kasus")
plt.title("Tren Kasus Pneumonia di Jawa Barat per Kabupaten/Kota")
plt.xticks(rotation=45)
plt.legend(bbox_to_anchor=(1.05, 1), loc='upper left')
plt.tight_layout()
plt.savefig('static/tren_semua_kota.png')
plt.close()

# Visualisasi boxplot distribusi kasus per tahun
plt.figure(figsize=(10, 6))
sns.boxplot(x='tahun', y='jumlah_kasus', data=df)
plt.xlabel("Tahun")
plt.ylabel("Jumlah Kasus")
plt.title("Distribusi Kasus Pneumonia per Tahun")
plt.xticks(rotation=45)
plt.tight_layout()
plt.savefig('static/distribusi_kasus.png')
plt.close()
...
plt.xlabel("Tahun")
plt.ylabel("Jumlah Kasus")
plt.title("Hasil Prediksi vs Data Aktual Kasus Pneumonia")
plt.legend()
